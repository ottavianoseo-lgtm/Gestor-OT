...
public class TankMixRulesController : ControllerBase
{
    ...
    public TankMixRulesController(IApplicationDbContext context, IAgronomicValidationService validationService)
    {
        _context = context;
    ...
    {
        var alerts = await _validationService.ValidateMixAsync(request.SupplyIds);
        return alerts;
    }
}
